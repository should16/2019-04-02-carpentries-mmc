...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-brightgreen.svg)](https://github.com/potterzot/<PROJECT NAME>/commits/master) 
[![minimal R version](https://img.shields.io/badge/R%3E%3D-3.0.3-brightgreen.svg)](https://cran.r-project.org/) 
[![Travis-CI Build Status](https://travis-ci.org/potterzot/<PROJECT NAME>.png?branch=master)](https://travis-ci.org/potterzot/<PROJECT NAME>) 
[![Coverage Status](https://coveralls.io/repos/github/potterzot/<PROJECT NAME>/badge.svg?branch=master)](https://coveralls.io/github/potterzot/<PROJECT NAME>?branch=master)
